...
export const OTPDisplay: React.FC<OTPDisplayProps> = ({ secret }) => {
  ...
  <div className="flex gap-3">
    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-slate-800 flex items-center justify-center text-xs font-bold text-indigo-400 border border-slate-700">
      1
    </span>
  ...
  <div className="flex gap-3">
    ...
    <p>Bước 3: Dán code vào ô trống → nhấn submit → copy mã 6 số.</p>
  </div>
